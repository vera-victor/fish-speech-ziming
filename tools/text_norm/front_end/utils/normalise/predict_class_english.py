...
# _DEFAULT_MODEL_PATH = r'D:\Data\TTS\英文正则化\xgb_model_v3'
_DEFAULT_MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models/xgb_modelV3')
# _DEFAULT_MODEL_PATH = r'D:\Code\Op202207\Text_Normalization\models\xgb_model_v3'
bst = xgb.Booster({'nthread': 4})
bst.load_model(_DEFAULT_MODEL_PATH)
...
def predict_class_(word_list, path=_DEFAULT_MODEL_PATH):
    ...
    # labels = ['PUNCT', 'PLAIN', 'LETTERS', 'DATE', 'CARDINAL', 'ORDINAL', 'VERBATIM',
    #           'TELEPHONE', 'MEASURE', 'DECIMAL', 'TIME', 'DIGIT', 'ELECTRONIC',
    #           'MONEY', 'ADDRESS', 'FRACTION']
